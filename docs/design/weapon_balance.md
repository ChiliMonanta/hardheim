...
| **Torch** | 19 (4 Blunt + 15 Fire), 1 Wood + 1 Resin | **14 (4 Blunt + 10 Fire), 2 Wood + 5 Resin** | The Torch's primary purpose is now to **light your way, not to fight**. It still one-shots Boar/Deer/Neck on a clean hit, but shatters after **2 melee hits** (in addition to its normal timed burn-out) and cannot be repaired. The steeper Resin cost (5x) makes recrafting after every break a real material sink, on top of losing your light source. Combat is a last resort, not a strategy. |
...
* **Torch: Light Source First, Weapon Never:** In vanilla, the Torch (19 Dmg, 1 Wood + 1 Resin) is a legitimate early club replacement with a bonus fire-fear effect. This mod redefines its role entirely: it caps damage at 14, raises the crafting cost to **2 Wood + 5 Resin**, and adds a **combat durability drain** where each melee hit consumes half its durability, so the Torch breaks after **2 attacks** regardless of its normal timed burn-out. Since Torches can't be repaired, every combat swing risks losing your only light source and costs 5x the Resin to replace. The Torch's job is to illuminate crypts and caves — pulling it out to fight should feel like a desperate, costly mistake, not a viable tactic.
